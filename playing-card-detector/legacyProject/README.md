# Original source
This can be considered a fork of the repository https://github.com/EdjeElectronics/OpenCV-Playing-Card-Detector by EdjeElectronics.
...
## Files
CameraTester.py contains a script for enumerating the first 10 camera indices on the system
...
OpenCV-Python 4.2.0 and numpy 1.17.4:
```
sudo apt update
