...
#
# Author: Evan Juras, Anders Steen (heavily copying from Adrian Rosebrock)
# Date: 1/12/18
# Description: Defines the VideoStream object, which controls
# acquisition of frames from a camera. The object uses
...
# for the lower processing power of a Raspberry Pi.
#
